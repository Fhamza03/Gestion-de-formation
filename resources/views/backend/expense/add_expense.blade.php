...
<div class="card">
    ...
    <div class="col-md-12">
        <div class="mb-3">
            <label for="expensive" class="form-label">Expense Details</label>
           <textarea name="expensive" class="form-control" id="example-textarea" rows="3" @error('expensive') is-invalid   @enderror></textarea>
           @error('expensive')
