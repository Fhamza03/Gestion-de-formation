                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="shopname" class="form-control" @error('shopname') is-invalid   @enderror placeholder="Enter shopname">
                                                @error('shopname')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="type" class="form-control" @error('type') is-invalid   @enderror placeholder="Enter type">
                                                @error('type')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="account_holder" class="form-control" @error('account_holder') is-invalid   @enderror placeholder="Enter account_holder">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="bank_branch" class="form-control" @error('bank_branch') is-invalid   @enderror placeholder="Enter bank_branch">
                                                @error('bank_branch')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
