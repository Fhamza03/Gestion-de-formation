                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" value="{{ $supplier->name }}" class="form-control"  @error('name') is-invalid   @enderror placeholder="Enter first name">
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="shopname" value="{{ $supplier->shopname }}" class="form-control" @error('shopname') is-invalid   @enderror placeholder="Enter shopname">
                                                @error('shopname')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="type" value="{{ $supplier->type }}" class="form-control" @error('type') is-invalid   @enderror placeholder="Enter type">
                                                @error('type')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="account_holder" value="{{ $supplier->account_holder }}" class="form-control" @error('account_holder') is-invalid   @enderror placeholder="Enter account_holder">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="bank_branch" value="{{ $supplier->bank_branch }}" class="form-control" @error('bank_branch') is-invalid   @enderror placeholder="Enter bank_branch">
                                                @error('bank_branch')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
