                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Add Formation</a></li>
                                            
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Add Formation</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form id="myForm" method="post" action="{{ route('product.store') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Add Formation</h5>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="firstname" class="form-label">Formation Name</label>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="product_code" class="form-control "   >
              ...
              <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="firstname" class="form-label">Formation Garage    </label>
            <input type="text" name="product_garage" class="form-control "   >
              ...
              <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="firstname" class="form-label">Formation Store    </label>
