...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
 ...
 <div class="content">
   ...
   <li class="breadcrumb-item"><a  class="btn btn-primary rounded-pill waves-effect waves-light" href="{{ route('all.product') }}">Back </a></li>
                                    ...
                                    <h4 class="page-title">Bar Code Formation</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Bar Code Formation</h5>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="firstname" class="form-label">Formation Code</label>
